                    ...
                    <div class="layui-card-body" pad15>
                        ...
                        <div class="layui-form" lay-filter="">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="money" lay-verify="required|money" placeholder="请输入提现金额"
                                           autocomplete="off" class="layui-input">
                                </div>

                                <label class="layui-form-label">提现手续费</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="withdraw_commission" placeholder="请输入提现手续费"
                                           autocomplete="off"
                                           class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="account_name" placeholder="请输入账号名称"  autocomplete="off"  class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label">提现账号</label>
                                <div class="layui-input-block">
                                    <input type="text" name="account_no" placeholder="请输入提现账号"  autocomplete="off"  class="layui-input">
                                </div>
                            </div>
    ...
    <script type="application/javascript">
        layui.use(['form', 'upload'], function () {
            ...
            axios.all([
                ...
                axios.post("/system/platform/payment/lists", {size: 1000}),
            ])
                .then(axios.spread(function (memberResp, paymentResp) {
                    ...
                    if (paymentResp.data.status) {
                        paymentResp.data.data.forEach(function (value, index, array) {
                            $('#payment_id').append("<option value='" + value.id + "'>" + value.name + "</option>");
                        });
                    }
                    form.render('select');
                }));
            form.on('submit(formSubmit)', function (data) {
                    ...
                    axios.post("{{url('system/member/wallet/withdraw/store')}}", field)
