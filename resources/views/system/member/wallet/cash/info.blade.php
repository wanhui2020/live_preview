                    ...
                    <div class="layui-card-body" pad15>
                        ...
                        <div class="layui-form" lay-filter="formData">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="email" readonly lay-verify="email" disabled
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="password" name="security_code" lay-verify="password"
                                           autocomplete="off" placeholder="请输入安全码" class="layui-input">
                                </div>
                            </div>
