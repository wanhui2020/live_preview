                    ...
                    <div class="layui-card-body" pad15>
                        ...
                        <div class="layui-form" lay-filter="">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <select name="payment_id" id="payment_id" lay-filter="payment_id" lay-verify="required"
                                            lay-search>
                                        <option value=""></option>
                                    </select>
                                </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="recharge_commission" placeholder="请输入充值手续费" autocomplete="off"
                                           class="layui-input">
                                </div>
                            </div>
    ...
    <script type="application/javascript">
        layui.use(['form', 'upload'], function () {
            ...
            form.on('submit(formSubmit)', function (data) {
                    ...
                    axios.post("{{url('system/member/wallet/recharge/store')}}", field)
