    ...
    <script type="application/javascript">
        layui.use(['table'], function () {
            ...
            let tableIns = table.render({
                elem: '#lists'
                , url: '{{url('system/member/signin/lists')}}' //数据接口
                , method: 'POST'
                , toolbar: '#toolbar'
                , page: true //开启分页
                , title: '会员签到'
                , cols: [[
                    ...
                    , {field: 'award', title: '奖励金币', align: 'center'}
                    // , {field: 'continuous_days', title: '连续签到天数', align: 'center'}
                    , {field: 'signin_date', title: '签到日期', align: 'center'}
                ]]
            });
                ...
                switch (obj.event) {
                    case 'add':
                        layer.open({
                            type: 2
                            , title: '新增签到'
                            , content: '{{url('system/member/signin/create')}}'
                            , maxmin: true
                            , area: ['800px', '400px']
                            , end: function () {
                                tableIns.reload();
