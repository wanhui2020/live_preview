        ...
        <div class="layui-card">
            <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input" name="dateTime" id="test" placeholder="登录时间"
                                   lay-key="17">
                        </div>
                    </div>
                    <div class="layui-inline">
    ...
    <script type="application/javascript">
        ...
        layui.use(['table'], function () {
            ...
            let tableIns = table.render({
                elem: '#lists'
                , url: '{{url('system/member/login/lists')}}' //数据接口
                , method: 'POST'
                , toolbar: '#toolbar'
                , page: true //开启分页
                , title: '登录日志'
                , cols: [[
                    ...
                    , {
                        ...
                        templet: function (d) {
                            let html = d.login_time;
                            if (d.logout_time) {
                                html += '<br>' + d.logout_time;
                            }
                            return html;
                        }
                    }
                    , {field: 'login_ip', title: '登录IP', align: 'center'}
                    , {field: 'duration', title: '在线时长', align: 'center'}
                    , {field: 'versions', title: '客户端版本号', align: 'center'}
                    , {field: 'platform', title: '客户端手机平台', align: 'center'}
                    , {field: 'client', title: '客户端手机型号', align: 'center'}
                ]]
            });
