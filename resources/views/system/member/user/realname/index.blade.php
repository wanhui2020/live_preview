        ...
        <div class="layui-card">
            <div class="layui-form layui-card-header layuiadmin-card-header-auto">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <div class="layui-input-inline">
                            <input type="text" name="idcard" placeholder="身份证号/真实姓名" autocomplete="off"
                                   class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
    ...
    <script type="application/javascript">
        ...
        layui.use(['table'], function () {
            ...
            let tableIns = table.render({
                elem: '#lists'
                , url: '{{url('system/member/user/realname/lists')}}' //数据接口
                , method: 'POST'
                , toolbar: '#toolbar'
                , page: true //开启分页
                , title: '会员管理'
                , cols: [[
                    ...
                    , {
                        field: 'idcard_front', title: '身份证正面照', align: 'center',
                        templet: function (d) {
                            if (d.idcard_front != null) {
                                return '<div onclick="show_img(this)" ><img src="' + d.idcard_front + '" alt="" width="50px" height="50px"></a></div>';
                            } else {
                                return '无';
                            }
                        }
                    ...
                    , {
                        field: 'idcard_back', title: '身份证反面照', align: 'center',
                        templet: function (d) {
                            if (d.idcard_back != null) {
                                return '<div onclick="show_img(this)" ><img src="' + d.idcard_back + '" alt="" width="50px" height="50px"></a></div>';
                            } else {
                                return '无';
                            }
                        }
                    ...
                    , {
                        field: 'idcard_hand', title: '手持身份证', align: 'center',
                        templet: function (d) {
                            if (d.idcard_hand != null) {
                                return '<div onclick="show_img(this)" ><img src="' + d.idcard_hand + '" alt="" width="50px" height="50px"></a></div>';
                            } else {
                                return '无';
                            }
                        }
                    ...
                    , {
                        ...
                        templet: function (d) {
                            ...
                            if (d.status === 8) {
                                return '<span style="color: yellowgreen;">待确认</span>';
                            }
                            if (d.status === 9) {
                                return '<span style="color: orange;">待审核</span>';
                            }
            ...
            table.on('tool(lists)', function (obj) {
                ...
                if (layEvent === 'audit') { //审核
                    layer.confirm('确认审核？', {
                        ...
                        axios.post("{{url('system/member/user/realname/audit')}}", {
                            id: data.id,
                            status: 0
                        })
                ...
                if (layEvent === 'edit') { //编辑
                    layer.open({
                        type: 2
                        , title: '编辑实名认证'
                        , content: '{{url('system/member/user/realname/edit?id=')}}' + data.id
                        , maxmin: true
                        , area: ['1000px', '800px']
                        , end: function () {
                            tableIns.reload();
