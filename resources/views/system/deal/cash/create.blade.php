...
{{--                                <div class="layui-input-inline">--}}
{{--                                    <input type="text" name="commission" lay-verify="required|money"--}}
{{--                                           placeholder="手续费"  autocomplete="off" class="layui-input">--}}
    ...
    <script type="application/javascript">
        layui.use(['form', 'upload'], function () {
            ...
            form.on('submit(formSubmit)', function (data) {
                    ...
                    axios.post("{{url('system/deal/cash/store')}}", field)
