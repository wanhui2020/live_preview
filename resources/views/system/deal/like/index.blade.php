    ...
    <script type="application/javascript">
        layui.use(['table'], function () {
            ...
            let tableIns = table.render({
                elem: '#lists'
                , url: '{{url('system/deal/like/lists')}}' //数据接口
                , method: 'POST'
                , toolbar: '#toolbar'
                , page: true //开启分页
                , title: '点赞'
                , cols: [[
                    ...
                    ,  {field: 'updated_at', title: '点赞时间', align: 'center'}
                    , {
                ...
                switch (obj.event) {
                    case 'add':
                        layer.open({
                            type: 2
                            , title: '新增关注'
                            , content: '{{url('system/deal/like/create')}}'
                            , maxmin: true
                            , area: ['800px', '400px']
                            , end: function () {
                                tableIns.reload();
            ...
            table.on('tool(lists)', function (obj) {
                ...
                if (layEvent === 'detail') { //查看
                    ...
                    layer.confirm('真的删除么', function (index) {
                        axios.post("{{url('system/deal/like/destroy')}}", {ids: [data.id]})
