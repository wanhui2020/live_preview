                    ...
                    <div class="layui-card-body" pad15>
                        <div class="layui-form" lay-filter="" wid100>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <select name="vip_id"  id="vip_id"  class="layui-input" >
                                        <option value="" selected>请选择</option>
                                    </select>
                                </div>
                            </div>
    ...
    <script type="application/javascript">
        layui.use(['form', 'upload'], function () {
            ...
            axios.all([
                ...
                .then(axios.spread(function (memberResp, vipResp) {
                    ...
                    if (vipResp.data.status) {
                        vipResp.data.data.forEach(function (value, index, array) {
                            $('#vip_id').append("<option value='" + value.id + "'>" + value.name + "</option>");
                        });
                    }
                    form.render('select');
                }));
            ...
            form.on('submit(formSubmit)', function (data) {
                    ...
                    axios.post("{{url('system/deal/vip/store')}}", field)
