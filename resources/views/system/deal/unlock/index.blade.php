    ...
    <script type="application/javascript">
        layui.use(['table'], function () {
            ...
            let tableIns = table.render({
                elem: '#lists'
                , url: '{{url('system/deal/unlock/lists')}}' //数据接口
                , method: 'POST'
                , toolbar: '#toolbar'
                , page: true //开启分页
                , title: '聊天解锁'
                , cols: [[
                    ...
                    , {
                        field: 'to_member_id', title: '解锁会员', width: 160,
                        templet: function (d) {
                            if (d.tomember) {
                    ...
                    , {field: 'gold', title: '解锁金币', align: 'center'}
                    , {field: 'commission', title: '平台佣金', align: 'center'}
                    , {field: 'received', title: '会员实收', align: 'center'}
                    , {field: 'end_time', title: '有效期止', align: 'center'}
                ]]
            });
                ...
                switch (obj.event) {
                    case 'add':
                        layer.open({
                            type: 2
                            , title: '礼物赠送'
                            , content: '{{url('system/deal/unlock/create')}}'
                            , maxmin: true
                            , area: ['800px', '400px']
                            , end: function () {
                                tableIns.reload();
