                    ...
                    <div class="layui-card-body" pad15>
                        ...
                        <div class="layui-form" lay-filter="">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <textarea id="demo" lay-verify="article_desc" name="content" placeholder="请输入内容"
        ...
        layui.use(['form', 'upload', 'layedit'], function () {
            ...
            form.on('submit(formSubmit)', function (data) {
                    let field = data.field
                        ...
                        , index_type = type.length - 1
                        , sname = name.charAt(index_name)
                        , stype = name.charAt(index_type);
                    if (IllegalString.indexOf(sname) >= 0) {
                        layer.alert("协议名称不能是特殊字符", {icon: 2});
                        return false;
                    }
                    if (IllegalString.indexOf(stype) >= 0) {
                        layer.alert("协议类型不能是特殊字符", {icon: 2});
                        return false;
                    }
