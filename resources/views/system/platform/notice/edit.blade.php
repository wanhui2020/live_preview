            ...
            <div class="layui-card-body" pad15>
                <div class="layui-form" lay-filter="formData">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea id="editor" name="content" style="width:100%;height:500px;" class="layui-textarea">{{ $cons->content }}</textarea>
                                    {{--<textarea name="content" id="content" lay-verify="article_desc" placeholder="请输入内容"--}}
    ...
    <script type="application/javascript">
        ...
        layui.use(['form', 'upload', 'layedit'], function () {
            ...
            form.on('submit(formSubmit)', function (data) {
                    ...
                    let index = parent.layer.getFrameIndex(window.name);
                    axios.post("{{url('system/platform/notice/update')}}", field)
