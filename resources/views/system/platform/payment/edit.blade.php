                        ...
                        <div class="layui-form" lay-filter="formData">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="min_money" placeholder="请输入最小金额" autocomplete="off"
                                           class="layui-input">
                                </div>
                                <label class="layui-form-label">最大金额</label>
                                <div class="layui-input-inline">
                                    <input type="text" name="max_money" placeholder="请输入最大金额" autocomplete="off"
                                           class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <textarea autocomplete="off" rows="6" name="parameter"
    ...
    <script type="application/javascript">
        layui.use(['form', 'upload', 'layedit'], function () {
            ...
            form.on('submit(formSubmit)', function (data) {
                    ...
                    axios.post("{{url('system/platform/payment/update')}}", field)
