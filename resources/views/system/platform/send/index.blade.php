                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        <div class="layui-input-inline">
                            <input type="text" name="key" placeholder="请输入内容" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-inline">
                        <div class="layui-input-inline">
    ...
    <script type="application/javascript">
        layui.use(['table', 'laydate'], function () {
            ...
            let tableIns = table.render({
                elem: '#lists'
                , url: '{{url('system/platform/send/lists')}}' //数据接口
                , method: 'POST'
                , toolbar: '#toolbar'
                , page: true //开启分页
                , title: '标签管理'
                ...
                switch (obj.event) {
                    case 'add':
                        layer.open({
                            type: 2
                            , title: '添加'
                            , content: '{{url('system/platform/send/create')}}'
                            , maxmin: true
                            , area: ['800px', '500px']
                            , end: function () {
                                tableIns.reload();
            ...
            table.on('tool(lists)', function (obj) {
                ...
                if (layEvent === 'status') { //改变状态
                    ...
                    layer.open({
                        type: 2
                        , title: '编辑'
                        , content: '{{url('system/platform/send/edit?id=')}}' + data.id
                        , maxmin: true
                        , area: ['800px', '500px']
                        , end: function () {
                            tableIns.reload();
                    ...
                    layer.confirm('确定要删除么？', {
                        ...
                        axios.post("{{url('system/platform/send/destroy')}}", {ids: [data.id]})
                            .then(function (response) {
