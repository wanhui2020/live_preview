                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                @foreach($condition as $item)
                                    <input type="checkbox" name="condition" title="{{$item['name']}}" value="{{$item['id']}}" @if(isset($cons['condition_id']) && in_array($item['id'], $cons['condition_id'])) checked="checked" @endif><div class="layui-unselect layui-form-checkbox layui-form-checked"><span>{{$item['name']}}</span><i class="layui-icon layui-icon-ok"></i></div>
                                @endforeach
                            </div>
                        </div>
                    @endif
    ...
    <script type="application/javascript">
        layui.use(['form', 'upload', 'layedit'], function () {
            ...
            form.on('submit(formSubmit)', function (data) {
                    ...
                    let index = parent.layer.getFrameIndex(window.name);
                    axios.post("{{url('system/platform/type/update')}}", field)
