                        ...
                        <div class="layui-form" lay-filter="formData">
                            ...
                            <div class="layui-form-item" >
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="title" lay-verify="required" placeholder="请输入标题称" autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item" >
                                ...
                                <div class="layui-input-block">
                                    <textarea id="demo" lay-verify="article_desc" class="layui-textarea" name="content"  placeholder="请输入内容">{{ $cons->content }}</textarea>
                                </div>
                            </div>
    ...
    <script type="application/javascript">
        layui.use(['form', 'upload','layedit'], function () {
            ...
            form.on('submit(formSubmit)', function (data) {
                    ...
                    let index = parent.layer.getFrameIndex(window.name);
                    axios.post("{{url('system/platform/news/update')}}", field)
