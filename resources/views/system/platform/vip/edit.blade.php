            ...
            <div class="layui-card-body" pad15>
                <div class="layui-form" lay-filter="formData">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea id="editor" name="describe" style="width:100%;height:100px;" class="layui-textarea">{{ $vip->describe }}</textarea>
                        </div>
                    </div>
                    <div class="layui-form-item ">
                        <div class="layui-input-block">
        ...
        layui.use(['form', 'upload' ], function () {
            ...
            form.on('submit(formSubmit)', function (data) {
                ...
                field.describe = content;
                    axios.post("{{url('system/platform/vip/update')}}", field)
