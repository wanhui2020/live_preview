        ...
        layui.use(['table', 'laydate'], function () {
            ...
            let tableIns = table.render({
                ...
                , cols: [[
                    ...
                    {field: 'name', title: '礼物名称', align: 'center'}
                    , {field: 'gold', title: '能量价格', align: 'center'}
                    , {
                        field: 'ico', title: '图标', align: 'center',
                        templet: function (d) {
                            if (d.ico != null) {
                                return '<div onclick="show_img(this)" ><img src="' + d.ico + '" alt=""  height="40px"></a></div>';
                            } else {
                                return '';
                            }
                        }
                    }
                    , {field: 'cartoon', title: '动画地址', align: 'center'}
                    , {
