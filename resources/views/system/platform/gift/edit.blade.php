                ...
                <div class="layui-card">
                    ...
                    <div class="layui-card-body" pad15>
                        ...
                        <div class="layui-form" lay-filter="formData">
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label">能量价格</label>
                                <div class="layui-input-block">
                                    <input type="text" name="gold" lay-verify="required|moneyMinus" placeholder="请输入能量价格"
                                           autocomplete="off" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item" id="tupian">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="ico" id="ico" placeholder="请输入图片地址" autocomplete="off"
                                           class="layui-input">
                                    @if($data->ico)
                                    <img src="{{ $data->ico }}" style="max-height: 100px; " id="imgs">
                                    @endif
    ...
    <script type="application/javascript">
        layui.use(['form', 'upload', 'layedit'], function () {
            ...
            form.on('submit(formSubmit)', function (data) {
                    ...
                    axios.post("{{url('system/platform/gift/update')}}", field)
