        ...
        layui.use(['table', 'laydate'], function () {
            ...
            let tableIns = table.render({
                ...
                , cols: [[
                    ...
                    , {field: 'describe', title: '标签描述', align: 'center'}
                    , {field: 'ico', title: '标签图标', align: 'center',
                        templet: function (d) {
                            if (d.ico != null) {
                                return '<div onclick="show_img(this)" ><img src="' + d.ico + '" alt="" width="500px" height="50px"></a></div>';
                            } else {
                                return '';
                            }
                        }
