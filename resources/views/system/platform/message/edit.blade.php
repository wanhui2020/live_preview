                        ...
                        <div class="layui-form" lay-filter="formData">
                            ...
                            <div class="layui-form-item" id="tupian">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <img src="{{ $cons->pic }}" style="height: 60px; " id="imgs">
                                    <input type="hidden" name="pic" id="pic" value="{{$cons->pic}}">
                            ...
                            <div class="layui-form-item" >
                                ...
                                <div class="layui-input-block">
                                    <textarea  name="content"  id="demo" lay-verify="article_desc" placeholder="请输入内容" class="layui-textarea">{!! $cons->content !!}</textarea>
                                </div>
    ...
    <script type="application/javascript">
        layui.use(['form', 'upload','layedit'], function () {
            ...
            form.on('submit(formSubmit)', function (data) {
                    ...
                    let index = parent.layer.getFrameIndex(window.name);
                    axios.post("{{url('system/platform/message/update')}}", field)
