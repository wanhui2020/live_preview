        ...
        <div class="layui-row layui-col-space15">
            ...
            <div class="layui-col-sm6 layui-col-md3">
                <div class="layui-card">
                    ...
                    <div class="layui-card-body layuiadmin-card-list">
                        <p class="layuiadmin-big-font">{{$data['recharge_today']}}</p>
                        <p>
                            昨日充值
                            <span class="layuiadmin-span-color">{{$data['recharge_yesterday']}}</span>
                        </p>
                    </div>
                </div>
            </div>
            <div class="layui-col-sm6 layui-col-md3">
                <div class="layui-card">
                    ...
                    <div class="layui-card-body layuiadmin-card-list">
                        <p class="layuiadmin-big-font">{{$data['withdraw_today']}}</p>
                        <p>
                            昨日提现
                            <span class="layuiadmin-span-color">{{$data['withdraw_yesterday']}}</span>
                        </p>
                    </div>
                </div>
            </div>
            <div class="layui-col-sm6 layui-col-md3">
                <div class="layui-card">
                    ...
                    <div class="layui-card-body layuiadmin-card-list">
                        <p class="layuiadmin-big-font">{{$data['user_count_today']}}</p>
                        <p>
                            昨日新增
                            <span class="layuiadmin-span-color">{{$data['user_count_yesterday']}}人</span>
                        </p>
                    </div>
                </div>
            </div>
            <div class="layui-col-sm6 layui-col-md3">
                <div class="layui-card">
                    ...
                    <div class="layui-card-body layuiadmin-card-list">
                        <p class="layuiadmin-big-font">{{$data['user_online_today']}}</p>
                        <p>
                            昨日活跃
                            <span class="layuiadmin-span-color">{{$data['user_online_yesterday']}}人</span>
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            {{--<div class="layui-col-sm4">--}}
                                {{--<div class="layuiadmin-card-list">--}}
                                    ...
                                    {{--<div class="layui-progress layui-progress-big" lay-showPercent="yes">--}}
                                        {{--<div class="layui-progress-bar" lay-percent="{{$data['login']}}"></div>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                                {{--<div class="layuiadmin-card-list">--}}
                                    ...
                                    {{--<span>同上期增长</span>--}}
                                    {{--<div class="layui-progress layui-progress-big" lay-showPercent="yes">--}}
                                        {{--<div class="layui-progress-bar" lay-percent="{{$data['platform_record_money']}}"></div>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                            {{--</div>--}}
                        {{--</div>--}}
...
@section('script')
    ...
    {{--<script src="{{ asset('plugins/layuiadmin/modules/sample.js')}}"></script>--}}
    {{--<script src="{{ asset('plugins/layuiadmin/lib/admin.js')}}"></script>--}}
    {{--<script src="{{ asset('plugins/layuiadmin/lib/extend/echarts.js')}}"></script>--}}
    {{--<script src="{{ asset('plugins/layuiadmin/lib/extend/echartsTheme.js')}}"></script>--}}
@endsection
