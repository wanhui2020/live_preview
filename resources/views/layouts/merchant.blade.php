...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }}-商户</title>
...
<div id="app">
    ...
    @include('merchant.common.header',['page'=>'文章页'])
...
<script type='text/javascript'>
    let user =@json(Auth::guard('MerchantUser')->user());
    //
    //
    ...
    //     console.log('连接成功');
    //     socket.emit('login', {'type': 'merchant', 'id': user.id});
    // });
