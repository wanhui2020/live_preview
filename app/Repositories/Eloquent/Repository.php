...
abstract class Repository implements RepositoryInterface, CriteriaInterface
{
    ...
    public function whereColumn(array $relations)
    {
        $this->applyCriteria();
        $this->model = $this->model->whereColumn($relations);
        return $this;
    }
    ...
    {
        $this->model = $this->model->select($where);
        return $this;
    }


    public function selectRaw( $where)
    {
        $this->model = $this->model->selectRaw($where);
        return $this;
    }
    ...
    public function havingRaw($where)
    {
        $this->model = $this->model->havingRaw($where);
        return $this;
    }

    public function groupBy($where)
    {
        $this->model = $this->model->groupBy($where);
        return $this;
    }
    ...
    public function doesntHave($attribute)
    {
        $this->applyCriteria();
        $this->model = $this->model->doesntHave($attribute);
        return $this;
    }

    public function whereDoesntHave($attribute, $where)
    {
        $this->applyCriteria();
        $this->model = $this->model->whereDoesntHave($attribute, $where);
        return $this;
    }
...
//        $this->applyCriteria();
    ...
    {
        $this->model = $this->model->get($data);
        return $this;
    }
    ...
    {
        $this->applyCriteria();
        $this->model = $this->model->whereIn($attribute, $ids);
        return $this;
    }
